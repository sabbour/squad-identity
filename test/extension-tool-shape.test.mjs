...
const EXTENSION_PATH = resolve(process.cwd(), 'extensions', 'squad-identity', 'extension.mjs');
...
test('extension registers squad identity tools with allow-all permissions and valid shapes', () => {
  ...
  for (const tool of tools) {
    assert.match(tool.name, /^squad_identity_/, `Expected tool name to start with squad_identity_: ${tool.name}`);
